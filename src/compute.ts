...
import lambdaEventSources from '@aws-cdk/aws-lambda-event-sources'
...
export class OmicsWorkflowStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const ruleWorkflowStatusTopic = new events.Rule(this, `${APP_NAME}_rule_workflow_status_topic`, {
      eventPattern: {
        source: ['aws.omics'],
